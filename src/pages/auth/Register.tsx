  ...
  return (
    <div className="w-full min-h-screen bg-white flex flex-col">
      ...
      <div className="flex-1 bg-white px-6 pt-2 pb-10 flex flex-col overflow-y-auto">
        ...
        <p className="text-sm text-gray-400 text-center mb-6">Buat akun Anda sekarang</p>
        ...
        <form onSubmit={handleRegister} className="flex flex-col gap-3 mb-5">
          ...
          <div className="relative">
            <span className="absolute left-4 top-1/2 -translate-y-1/2 text-[#7a8c2e]">
              <Icon icon="mdi:lock-check-outline" className="text-xl" />
            </span>
            <input
              type="password"
        ...
        <p className="text-center text-sm text-gray-500 mb-6">
          Sudah Punya Akun?{' '}
          <a href="/login" className="text-gray-800 font-bold underline hover:text-[#7a8c2e] transition-colors">
            Masuk Sekarang
          </a>
        </p>
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <span className="text-xs text-gray-500 font-medium whitespace-nowrap">Atau daftar dengan</span>
          <div className="flex-1 h-px bg-gray-200" />
        </div>
